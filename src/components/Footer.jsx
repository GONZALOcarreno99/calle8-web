      ...
      >
        <div className="group flex items-center gap-3">
          ...
          <div className="text-left">
            <p className="font-display text-xl tracking-wide leading-none transition-colors duration-300 group-hover:text-gold group-active:text-gold">CALLE OCHO</p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-white/60">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="link-underline hover:text-gold active:text-gold transition-colors"
          >
            {prettyNumber}
          </a>
          <a
